...
CaculateApp is an Android app (Kotlin) for rice weighing management, targeting Vietnamese farmers. Users weigh rice bags, record weights in a column-based grid (5 bags per column), and export invoices as PDF or images. All data syncs to Firebase Firestore with offline-first support.
...
# Run tests
rtk ./gradlew test
rtk ./gradlew connectedAndroidTest  # instrumented tests
...
**Export**: `ExportManager` generates multi-page PDF/images from column data. Columns are chunked into groups of 10 per export page.
